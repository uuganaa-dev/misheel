...
const CreatedBy = () => {
  ...
  const Validate = () => {
    ...
    images.length > 0 ||
      (validation += "Бусад зураг багадаа 1 -г оруулна уу!<br/>");
    project || (validation += "project id бичнэ үү!<br/>");
    title || (validation += "Нэр бичнэ үү!<br/>");
  ...
  return (
    <Modal
      visible={admin.createdby}
      onCancel={() => setAdmin({ type: "CREATED_BY", data: false })}
      centered
      footer={false}
      width={800}
    >
